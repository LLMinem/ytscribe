Title: First steps | uv

URL Source: https://docs.astral.sh/uv/getting-started/first-steps/
...
[Skip to content](https://docs.astral.sh/uv/getting-started/first-steps/#first-steps-with-uv)

[![Image 1: logo](https://docs.astral.sh/uv/assets/logo-letter.svg)](https://docs.astral.sh/uv/ "uv")
...
- - [x] [Getting started](https://docs.astral.sh/uv/getting-started/) Getting started
  ...
  * - [x] First steps [First steps](https://docs.astral.sh/uv/getting-started/first-steps/) Table of contents
    * [Next steps](https://docs.astral.sh/uv/getting-started/first-steps/#next-steps)
...
- - [x] [Guides](https://docs.astral.sh/uv/guides/) Guides
  ...
  * - [x] [Integrations](https://docs.astral.sh/uv/guides/integration/) Integrations
    ...
    * [Dependency bots](https://docs.astral.sh/uv/guides/integration/dependency-bots/)
...
2. [Getting started](https://docs.astral.sh/uv/getting-started/)

# [First steps with uv](https://docs.astral.sh/uv/getting-started/first-steps/#first-steps-with-uv)

After [installing uv](https://docs.astral.sh/uv/getting-started/installation/), you can check that uv is available by running the `uv` command:
...
Now that you've confirmed uv is installed, check out an [overview of features](https://docs.astral.sh/uv/getting-started/features/), learn how to [get help](https://docs.astral.sh/uv/getting-started/help/) if you run into any problems, or jump to the [guides](https://docs.astral.sh/uv/guides/) to start using uv.

September 3, 2024

Back to top [Previous Installation](https://docs.astral.sh/uv/getting-started/installation/)[Next Features](https://docs.astral.sh/uv/getting-started/features/)
