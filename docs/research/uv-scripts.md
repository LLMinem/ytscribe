...
URL Source: https://docs.astral.sh/uv/guides/scripts/
...
![Image 1: Run Result](https://docs.astral.sh/uv/assets/uv_gui_script_hello_world.png)
...
![Image 2: Run Result](https://docs.astral.sh/uv/assets/uv_gui_script_hello_world_pyqt.png)
